...
//     // Hitung total dan prepare items
//     let total = 0;
//     const items = [];
//     try {
...
//         items.push({
//           id: item.Product.id.toString(), // Ensure ID is string
//           price: price,
//           quantity: item.quantity,
//           name: item.Product.nama_produk,
//         });
//       });
//       console.log("Total calculated:", total, "Items:", items.length);
//     } catch (calcError) {
//       console.error("Calculation error:", calcError);
//       await t.rollback();
//       return res.status(500).json({
//         message: "Gagal menghitung total pesanan",
...
//         }
//       }
//       console.log("Order details and stock updates completed");
//     } catch (detailsError) {
...
//     // Setup Midtrans and create token
//     let midtransToken;
//     try {
...
//       console.log("Midtrans parameters:", JSON.stringify(transactionDetails));
//       midtransToken = await snap.createTransactionToken(transactionDetails);
//       console.log("Midtrans token created:", midtransToken);
//     } catch (midtransError) {
...
//       await t.rollback();
//       return res.status(500).json({
//         message: "Gagal membuat catatan pembayaran",
...
//       payment: {
//         token: midtransToken,
//         redirect_url: `https://app.sandbox.midtrans.com/snap/v2/vtweb/${midtransToken}`,
//       },
//     });
//   } catch (error) {
//     await t.rollback();
...
async function updateTransactionStatus(req, res, next) {
  try {
    ...
    // Opsional: Validasi apakah user adalah pemilik order atau admin
